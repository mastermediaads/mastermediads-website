  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative rounded-[32px] liquid-glass-card p-8 sm:p-12 lg:p-14 text-right border border-white/20 shadow-2xl overflow-hidden">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-cyanGlow-300 text-xs sm:text-sm font-bold mb-5">
          ...
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight font-heading leading-tight mb-4 max-w-3xl">
            جاهز تجعل علامتك التجارية أكثر حضوراً؟
          </h2>

          {/* Inspiring Subtitle */}
          <p className="text-sm sm:text-lg text-slate-300 leading-relaxed max-w-2xl mb-8 font-normal">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-start gap-3.5 max-w-md">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-full text-sm font-bold text-emerald-300 bg-emerald-950/50 hover:bg-emerald-900/60 border border-emerald-500/40 hover:border-emerald-400 transition-all shadow-md"
            >
          ...
          {/* Trust Highlights */}
          <div className="mt-10 pt-6 border-t border-white/10 flex flex-wrap items-center justify-start gap-5 text-xs text-slate-300">
            <span className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-cyanGlow-400" />
